        ...
        <CCard>
          <CCardBody>
            <CForm @submit.prevent="themNguoiDung">
              ...
              <!-- Mật khẩu cũ-->
              <div class="mb-3">
                <CFormLabel for="matKhau">Mật khẩu cũ:</CFormLabel>
                <CFormInput id="matKhau" v-model="nguoiDung.matKhau" type="password" required disabled/>
              </div>
              
              <!-- Mật khẩu -->
              <div class="mb-3">
                <CFormLabel for="matKhau">Mật khẩu:</CFormLabel>
              ...
              <div class="mb-3">
                ...
                <div>
                  <CFormCheck inline :checked="nguoiDung.trangThai === 'Bật'" label="Bật" type="radio" value="Bật"
                    v-model="nguoiDung.trangThai" />
                  <CFormCheck inline :checked="nguoiDung.trangThai === 'Tắt'" label="Tắt" type="radio" value="Tắt"
                    v-model="nguoiDung.trangThai" />
                </div>
              </div>
              ...
              <!-- Buttons -->
              <div class="d-flex justify-content-center">
                <CButton class="me-2" color="primary" type="submit">Thêm tài khoản</CButton>
